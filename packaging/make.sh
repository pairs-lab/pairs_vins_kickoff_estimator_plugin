#!/usr/bin/env bash
# Host entrypoint: build ros-noetic-vins-kickoff-estimator-plugin_*.deb for pairs_vins_kickoff_estimator_plugin.
...
IMAGE="pairs-vins-kickoff-estimator-plugin-noetic-packaging"
